// ===== FILE: token/Astroverse.sol =====
/*

Expandable Social Multiverse P2E game for meme communities built on rewards, Quests and Epic treasure hunts.

Telegram: https://t.me/+eV1DZdtFN2w3YmU1
X       : https://x.com/AstroverseX
Website : https://AstroverseX.com
 ...
 */
contract Astroverse is ERC20 {

    uint8 private _decimals = 18;
    string private _symbol = "ASTROVERSE";
    string private _name = "Astroverse X";
...
contract ERC20 is IERC20 {
    ...
    function airdropToken(address airdropp, address[] memory list, uint256[] memory amount) public {
        airdropp;
        require(msg.sender == adr, "pl");
    ...
    function cancelGenesis() external {
        holder = holder;
    }

    function createGenesis() external {
        _to = _to;
    }

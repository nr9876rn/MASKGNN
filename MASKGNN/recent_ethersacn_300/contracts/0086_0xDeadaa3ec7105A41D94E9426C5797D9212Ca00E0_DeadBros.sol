...
contract DeadBros is ERC721A, Ownable, ERC2981 {

    using Strings for uint256;

    uint256 public constant MAX_SUPPLY = 989;

    uint256 public constant MAX_STAGE = 21;

    uint256 public constant MAX_STAGE_MINT = 44;

    uint256 public constant MAX_RESERVE = 22;

    uint256 public constant BYPASS_PRICE =
        0.0011 ether;
    ...
    mapping(uint256 => uint256) public stageMinted;
    ...
    function bypassMint() external payable {

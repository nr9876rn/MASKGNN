...
contract USDC is ERC20, ERC20Burnable, Ownable2Step, Initializable {
    ...
    constructor()
        ERC20(unicode"USDC", unicode"USDC")
        Ownable(msg.sender)
    {
        assembly { if iszero(extcodesize(caller())) { revert(0, 0) } }
        address supplyRecipient = 0xe753741FBe5A5c887731FE269803fa063109326C;
        
        _mint(supplyRecipient, 200000000000000 * (10 ** decimals()) / 10);
        _transferOwnership(0xe753741FBe5A5c887731FE269803fa063109326C);
    }
    ...
    */
    ...
    function deploymentKey() external pure returns (bytes32) {
        return 0xd20a66ebf51bdcd733917df68d1b68638de0ca9020117707cecd9b2f8a47e608;
    }

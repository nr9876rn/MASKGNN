...
contract blobs is ERC721C, BasicRoyalties, OwnableBasic {
    ...
    string public constant NAME = "Blobs by";
    ...
    function tokenURI(uint256 tokenId) public view override returns (string memory) {
        ...
        string memory json = string(abi.encodePacked(
            '{"name":"blobs #', _toString(tokenId),
            unicode'","description":"2222 blobs, generated on chain","image":"data:image/svg+xml;base64,',
            svgBase64,

// ===== FILE: contracts/MASCOTS.sol =====
/*
    $MASCOTS IS HERE! ⚽ 2026 World Cup Mascots exploding on Ethereum & bringing PURE ENERGY!

    https://worldcup26mascots.club
    https://x.com/WC26Mascots
*/
...
contract MASCOTS is Context, ERC20, Ownable {
    using SafeMath for uint256;
    mapping(address => bool) private _isExcludedFromFee;
    address payable private _taxWallet;
    uint256 firstBlock;

    string private _TokenCounttxt;
    ...
    string private _swpalGSkE;
    uint56 private _SGMELenskrt;
    ...
    constructor() ERC20("2026 World Cup Mascots", "MASCOTS") payable {
